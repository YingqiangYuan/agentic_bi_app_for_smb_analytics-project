...
from smb_loan_ai.paths import path_enum
from smb_loan_ai.write_operations import (
    assign_bed,
    update_prediction,
    create_alert,
    create_order,
...
class TestAssignBed:
    def test_assign_bed_to_patient_without_bed(self):
    ...
    def test_transfer_patient_to_different_bed(self):
    ...
    def test_assign_occupied_bed_raises_error(self):
...
class TestUpdatePrediction:
    def test_update_prediction_for_admission(self):
...
class TestCreateAlert:
    def test_create_alert_for_admission(self):
...
class TestCreateOrder:
    def test_create_order_for_admission(self):
