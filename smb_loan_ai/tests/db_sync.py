...
#
# See: tmp/fintech_smb_lending_pipeline_medium_er_document.md for full schema details.
TABLE_INSERT_ORDER = [
    # Independent lookup tables (no FK dependencies)
    "industry",
    "risk_grade",
    "loan_status",
    "loan_officer",
    # Depends on industry
    "customer",
    # Depends on customer, loan_officer, loan_status
    "application",
    # Depends on application, customer, risk_grade, loan_status
    "loan",
    # Depends on loan
    "repayment_schedule",
    "payment",
