...
```python
from smb_loan_ai.api import one  # Main singleton instance
```
...
```python
from smb_loan_ai.api import one           # Main app instance
...
- **System Prompt**: `smb_loan_ai/prompts/bi-agent-system-prompt.md`
